    ...
    getMenu(): AppMenu {
        return new AppMenu('MainMenu', 'MainMenu', [
            ...
            new AppMenuItem(
                ...
                [],
                [
                    new AppMenuItem('Governorates', 'Pages.Governorates', 'fa fa-circle', '/app/main/governorates'),
                    new AppMenuItem('Categories', 'Pages.Categories', 'fa fa-circle', '/app/main/categories'),
                    new AppMenuItem('Complexities', 'Pages.Complexities', 'fa fa-circle', '/app/main/complexities'),
                    new AppMenuItem('StudyLevels', 'Pages.StudyLevels', 'fa fa-circle', '/app/main/studyLevels'),
                    new AppMenuItem('StudySubjects', 'Pages.StudySubjects', 'fa fa-circle', '/app/main/studySubjects'),
                    new AppMenuItem('SubjectUnits', 'Pages.SubjectUnits', 'fa fa-circle', '/app/main/subjectUnits'),
                    new AppMenuItem('Students', 'Pages.Students', 'fa fa-circle', '/app/main/students'),
                    new AppMenuItem('Supervisors', 'Pages.Supervisors', 'fa fa-circle', '/app/main/supervisors'),
            ...
            new AppMenuItem('QuestionBank', 'Pages.Questions', 'flaticon-line-graph', '/app/main/question-bank'),
            new AppMenuItem('Templates', 'Pages.ExamTemplates', 'flaticon-line-graph', '/app/main/templates'),
            new AppMenuItem('Exams', 'Pages.Exams', 'flaticon-line-graph', '/app/main/exams'),
            new AppMenuItem('Sessions', 'Pages.Sessions', 'flaticon-line-graph', '/app/main/sessions'),
            // new AppMenuItem('MyExams', '', 'flaticon-line-graph', '/app/main/my-exams'),
            new AppMenuItem(
                'CorrectingSession',
                'Pages.Sessions.GetAllForCorrection',
                'flaticon-line-graph',
                '/app/main/correcting',
            ),
            new AppMenuItem(
                'AuditScreen',
                'Pages.Sessions.GetAllForAuditing',
                'flaticon-line-graph',
                '/app/main/audit',
            ),
