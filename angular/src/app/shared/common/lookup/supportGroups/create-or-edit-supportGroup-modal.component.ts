...
import {
    ...
    CreateOrEditSupportGroupDto,
    SupportGroupTypeEnum,
...
export class CreateOrEditSupportGroupModalComponent extends AppComponentBase implements OnInit {
    ...
    save(): void {
        ...
        this._supportGroupsServiceProxy
            .createOrEdit(this.supportGroup)
            .pipe(
                finalize(() => {
                    this.saving = false;
                }),
    ...
    ngOnInit(): void {
        this.supportGroupTypeEnum = Object.entries(SupportGroupTypeEnum)
